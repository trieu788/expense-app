...
public class Addnewtrip extends AppCompatActivity {
    ...
    trieuappproject trieuappproject =(trieuappproject) this.getApplication();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personList = trieuappproject.getPersonList();
        ...
        button2.setOnClickListener(view -> {
           /* FirebaseDatabase firebaseDatabase;
            ...
            int nextId = trieuappproject.getNextId();
                ...
                trieuappproject.setNextId(nextId++);
